...
export function UserPasteStatistics() {
  ...
  return (
    <div className='flex flex-col gap-2 select-none'>
      ...
      {isLoading && !data && <p className='text-center'>Loading account stats...</p>}
      ...
      <div className='flex gap-2 w-full items-center justify-center'>
        {data &&
          statistics.map(statistic => {
            ...
            return (
              <div key={statistic.name} className='flex gap-2 items-center bg-background-secondary p-1.5 rounded-md'>
